...
const baTable: baTableClass = new baTableClass(new baTableApi('/userApi/Taglog/'), {
    ...
    column: [
        ...
        { label: t('taglog.list.b_address'), prop: 'beacon_address', width: '150',align: 'center' },
        {
            label: t('taglog.list.g_address'),
        ...
        {  label: t('taglog.list.bt'), prop: 'bt',render: 'tag',width: '100',align: 'center',},


        {
            label: t('taglog.list.keys'),
            prop: 'keys1',
            align: 'center',
            render: 'tag',
            custom: { '-1': 'info', '1': 'danger' ,'0':'success'},
            replaceValue: { '-1':  '/', '1': t('taglog.list.keys1'), '0': t('taglog.list.keys2') },
        },
        {
            label: t('taglog.list.run'),
            prop: 'run',
            align: 'center',
            render: 'tag',
            custom: { '0': 'danger', '1': 'success' },
            replaceValue: { '-1':  '/', '1': t('taglog.list.onrun'), '0': t('taglog.list.unrun') },
        },
