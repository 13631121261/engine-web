    ...
    <div id='wrap' style='height: auto'>
        ...
        <el-card class="box-card">
            ...
            <div style='height: 450px;'>
                <el-input v-model="filterText" :placeholder="t('mac_filter')" />
        ...
        <div id='div2' style=' display: flex;  justify-content: center;  align-items: center;' >
            <div style=' align-items: center;'>
                <el-button :disabled='getAddDisable()' type="primary" style='margin-bottom: 10px' @click="appendChild()">
                    {{t('link')}}<el-icon class="el-icon--right" ><ArrowRight /></el-icon>
                </el-button>
                <el-button :disabled='getdelDisable()' type="danger" :icon="ArrowLeft" style='margin-left: 0px;margin-top: 10px' @click="remove()" >{{t('unlink')}}</el-button>
        ...
        <el-card class="box-card">
            <template #header>
                <div class="card-header">
                    <h1>{{ t('link_gateway') }}</h1>
                    <div>
                        <el-button style='margin-right: 0px' class="button" @click='reback()' >{{t('fanhui')}}</el-button>
                    <el-button  class="button" type="warning" @click='reset()' >{{t('reset')}}</el-button>
                    <el-button class="button" type="primary" :disabled='getcommitDisable()' @click="commit1()">{{t('submit')}}</el-button>
                    </div>
                </div>
            </template>
          <div style='height: 450px;'>
                <el-input v-model="filterTextb" :placeholder="t('mac_filter')" />
                <el-scrollbar style='height:300px;margin-bottom: 10px'>
