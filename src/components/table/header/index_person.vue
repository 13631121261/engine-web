<template>
    ...
    <div v-bind="$attrs" class="table-header ba-scroll-style">
        ...
        <el-switch  v-model="state.bind_status" @change='onchange' class="ml-2"
                    checked
                    inline-prompt
                    style="--el-switch-on-color: #66BBFF; --el-switch-off-color: #aaaaaa;margin-left: 20px"
                    :active-text="t('isbind')"
                    :inactive-text="t('nobind')"/>
...
const onchange=(value: any)=>{
    ...
    baTable.onTableHeaderAction('bind_status', { keyword: tag })
}
