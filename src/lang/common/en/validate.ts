export default {
    ...
    'Please enter address':'Please enter the complete MAC address not with a colon',
    'Please enter axis':'Gateway coordinate values support integer values between 1 and 999',
    'Please enter gateway_name':'Gateway name cannot exceed 10 characters，Without special symbols',
    'Please enter device Type Name':'The Name cannot exceed 50 characters，Without special symbols',
