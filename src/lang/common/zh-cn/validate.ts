export default {
    ...
    'Please enter address':'请输入完整MAC地址，不用带冒号',
    'Please enter axis':'网关坐标值支持1-999之间的整数值',
    'Please enter gateway_name':'网关名称不能超过10个字符，不含特殊符号',
    'Please enter device Type Name':'类型名称不能超过50个字符，没有特殊符号',
}
